...
2. **The training** — **Colab T4, `tools/colab_layout_finetune.ipynb`**.
...
**Gate 2 — end-to-end A/B (the one that decides).** `research/layout_yolo/gate.py`.
...
```bash
KHMER_LAYOUT_WEIGHTS=/path/khmer_layout_best.onnx uv run python research/layout_yolo/gate.py
```
