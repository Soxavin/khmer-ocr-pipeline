...
from-scratch CRNN exercise), and the main pipeline docs `docs/decisions/PROJECT_LOG.md` /
...
6. **Report:** fold results into `docs/report/REPORT.md` Track A; a negative result is
   still reported.
...
- Command shape (baseline vs fine-tuned): `tools/eval_document.py "<stem>" --preprocess`.
