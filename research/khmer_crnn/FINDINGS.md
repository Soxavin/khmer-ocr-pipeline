...
uv run python research/khmer_crnn/train.py --limit 10000 --epochs 3

# convergence (learnable curriculum)
uv run python research/khmer_crnn/train.py \
...
uv run --extra dev python research/khmer_crnn/plot_metrics.py research/khmer_crnn/runs/converge1
```
